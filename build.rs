...
fn main() {
    ...
    // Keep generated TableGen files and native objects under Cargo's output
    // directory so profile builds and MLIR-prefix changes cannot share stale
    ...
    println!("cargo:rustc-link-lib=static=printf_dialect");
